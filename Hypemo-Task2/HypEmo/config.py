...
config_args = {
    'training_config': {
        ...
        'alpha': (0.89, 'weight for BCE*poincare_dist loss'),
        'gamma': (0.11, 'weight for poincare loss')
    },
    ...
    'data_config': {
        'dataset': ('subtask1', 'which dataset to use'),
    }
}
...
def get_dicts(dataset, return_emb_dicts=False):
    ...
    if dataset == 'ED':
        ...
        label2idx =  {'Bandwagon': 1,'Presenting Irrelevant Data (Red Herring)': 0,'Smears': 2,'Glittering generalities (Virtue)': 3,
                      'Causal Oversimplification': 4, 'Whataboutism': 5, 'Loaded Language': 6, 'Exaggeration/Minimisation': 7,'Repetition': 8,
